...
VERSION = "3.0-PRO"
PROFILE = "Defensive detection control and telemetry simulation review"
RULES = [('SIM-TELEMETRY', 'telemetry|event|alert|detection'), ('SIM-CONTROL', 'control gap|coverage|rule|playbook'), ('SIM-SCOPE', 'authorization|scope|cleanup|rollback')]
...
def render_banner() -> None:
 ...
 | |__| | | | | |__| | |__| || |_
  \\_____|_| |_|\\____/ \\____/_____|
      GHOST-AttackSim v3.0-PRO (Zero-Guessing Engine)
"""
    print(banner)
